"""
Django settings for test_for_steph_48317 project.
...
ROOT_URLCONF = 'test_for_steph_48317.urls'
...
WSGI_APPLICATION = 'test_for_steph_48317.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_for_steph_48317 API",
    "DESCRIPTION": "API documentation for test_for_steph_48317 App",
    "VERSION": "v1",
}
